(function() {
  const PREFIX = "metaperf@mozilla.org:";

  addEventListener(PREFIX + "chrome-exec-event", function (e) {
    if (content.document.documentURI.indexOf("chrome://metaperf/content/metaperf.html")) {
      // Can have url fragment. Backward compatible version of !str.startsWidth("prefix")
      throw new Error("Cannot be used outside of metaperf's launch page");
    }
